...
std::map<std::string, std::pair<uint16_t, uint16_t>> skylanderMap = {
    ...
    // Core Skylanders
    {"Magic Skylander",     /* S3 Spyro */              {16, 0x2805}},
    {"Water Skylander",     /* S4 Gill Grunt*/          {14, 0x3805}},
    {"Air Skylander",       /* S3 Whirlwind */          {0, 0x2805}},
    {"Undead Skylander",    /* S3 Cynder */             {32, 0x2805}},
    {"Tech Skylander",      /* S3 Trigger Happy */      {19, 0x2805}},
    {"Fire Skylander",      /* S3 Eruptor */            {9, 0x2805}},
    {"Earth Skylander",     /* S3 Terrafin */           {5, 0x2805}},
    {"Life Skylander",      /* S3 Stealth Elf*/         {26, 0x2805}},
    {"Dark Skylander",      /* Blackout */              {485, 0x0000}},
    {"Light Skylander",     /* Spotlight */             {483, 0x0000}},

    // Giants
    {"Magic Giant",         /* Ninjini */               {109, 0x0000}},
    {"Water Giant",         /* Thumpback */             {107, 0x0000}},
    {"Air Giant",           /* Swarm */                 {101, 0x0000}},
    {"Undead Giant",        /* Eye Brawl */             {114, 0x0000}},
    {"Tech Giant",          /* Bouncer */               {110, 0x0000}},
    {"Fire Giant",          /* Hot Head */              {104, 0x0000}},
    {"Earth Giant",         /* Crusher */               {102, 0x0000}},
    {"Life Giant",          /* Tree Rex */              {112, 0x0000}},

    // Swap Force
    {"Magic Top",           /* Hoot Loop */             {2008, 0x0000}},
    {"Water Top",           /* Wash Buckler */          {2015, 0x0000}},
    {"Air Top",             /* Free Ranger */           {2001, 0x0000}},
    {"Undead Top",          /* Rattle Shake */          {2013, 0x0000}},
    {"Tech Top",            /* Magna Charge */          {2010, 0x0000}},
    {"Fire Top",            /* Blast Zone */            {2004, 0x0000}},
    {"Earth Top",           /* Rubble Rouser */         {2002, 0x0000}},
    {"Life Top",            /* Stink Bomb */            {2006, 0x0000}},

    {"Magic Bottom",        /* Hoot Loop */             {1008, 0x0000}},
    {"Water Bottom",        /* Wash Buckler */          {1015, 0x0000}},
    {"Air Bottom",          /* Free Ranger */           {1001, 0x0000}},
    {"Undead Bottom",       /* Rattle Shake */          {1013, 0x0000}},
    {"Tech Bottom",         /* Magna Charge */          {1010, 0x0000}},
    {"Fire Bottom",         /* Blast Zone */            {1004, 0x0000}},
    {"Earth Bottom",        /* Rubble Rouser */         {1002, 0x0000}},
    {"Life Bottom",         /* Stink Bomb */            {1006, 0x0000}},
    ...
    {"Magic Trap Master",   /* Blastermind */           {210, 0x300E}},
    {"Water Trap Master",   /* Snap Shot */             {211, 0x3001}},
    {"Air Trap Master",     /* Gusto */                 {212, 0x3003}},
    {"Undead Trap Master",  /* Krypt King */            {213, 0x3008}},
    {"Tech Trap Master",    /* Jawbreaker */            {214, 0x3007}},
    {"Fire Trap Master",    /* Wildfire */              {215, 0x3005}},
    {"Earth Trap Master",   /* Wallop */                {216, 0x3000}},
    {"Life Trap Master",    /* Tuff Luck */             {217, 0x300A}},
    {"Dark Trap Master",    /* Knight Mare */           {218, 0x3014}},
    {"Light Trap Master",   /* Knight Light */          {219, 0x300F}},

    // Superchargers
    {"Magic Supercharger",  /* Splat */                 {3402, 0x0000}},
    {"Water Supercharger",  /* D.D. Gill Grunt */       {3422, 0x0000}},
    {"Air Supercharger",    /* Stormblade */            {3406, 0x0000}},
    {"Undead Supercharger", /* B.B. Roller Brawl */     {3417, 0x0000}},
    {"Tech Supercharger",   /* D.D. Trigger Happy */    {3414, 0x0000}},
    {"Fire Supercharger",   /* Spitfire */              {3412, 0x0000}},
    {"Earth Supercharger",  /* Sh.Sh Terrafin */        {3416, 0x0000}},
    {"Life Supercharger",   /* Su.Sh Stealth Elf */     {3415, 0x0000}},
    {"Dark Supercharger",   /* Nightfall */             {3427, 0x0000}},
    {"Light Supercharger",  /* Astroblast */            {3426, 0x0000}},

    {"Land Vehicle",        /* Hot Streak */            {3224, 0x0000}},
    {"Sea Vehicle",         /* Splatter Splasher*/      {3238, 0x0000}},
