...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_Giants = {
    {"Swarm",                                           {101, 0x0000}},
    {"Crusher",                                         {102, 0x0000}},
...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_Swappers = {
...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_TrapMasters = {
    {"Gusto",                                           {450, 0x0000}},
...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_Minis = {
    {"Bop",                                             {502, 0x0000}},
...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_Superchargers = {
    {"Fiesta",                                          {3400, 0x0000}},
...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_Traps = {
...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_Vehicles = {
...
std::map<std::string, std::pair<uint16_t, uint16_t>> MLS_CreationCrystals = {
    /**
        Credits to:
            u/mariussa1 (Reddit)
            Tritonex (Youtube) 
