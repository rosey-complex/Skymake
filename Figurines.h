...
std::map<std::pair<uint16_t, uint16_t>, std::string> skImgList = { 
...
std::map<std::pair<uint16_t, uint16_t>, std::string> genericsList = {
    
    // Core skylanders (last made variants - Should work on all versions)
    {{16, 0x2805}, "Magic Skylander"},      // Series 3 Spyro
    {{14, 0x3805}, "Water Skylander"},      // Series 4 Gill Grunt
    {{0, 0x2805}, "Air Skylander"},         // Series 3 Whirlwind
    {{32, 0x2805}, "Undead Skylander"},     // Series 3 Cynder
    {{19, 0x2805}, "Tech Skylander"},       // Series 3 Trigger Happy
    {{9, 0x2805}, "Fire Skylander"},        // Series 3 Eruptor
    {{5, 0x2805}, "Earth Skylander"},       // Series 3 Terrafin
    {{26, 0x2805}, "Life Skylander"},       // Series 3 Stealth Elf
    {{485, 0x0000}, "Dark Skylander"},      // Blackout
    {{483, 0x0000}, "Light Skylander"},     // Spotlight

    // Giants
    {{109, 0x0000}, "Magic Giant"},         // Ninjini
    {{107, 0x0000}, "Water Giant"},         // Thumpback
    {{101, 0x0000}, "Air Giant"},           // Swarm
    {{114, 0x0000}, "Undead Giant"},        // Eye-Brawl
    {{110, 0x0000}, "Tech Giant"},          // Bouncer
    {{104, 0x0000}, "Fire Giant"},          // Hot Head
    {{102, 0x0000}, "Earth Giant"},         // Crusher
    {{112, 0x0000}, "Life Giant"},          // Tree Rex

    // Swap Force swappers
    {{2008, 0x0000}, "Magic Top"},          // Hoot Loop
    {{2015, 0x0000}, "Water Top"},          // Wash Buckler
    {{2001, 0x0000}, "Air Top"},            // Free Ranger
    {{2013, 0x0000}, "Undead Top"},         // Rattle Shake
    {{2010, 0x0000}, "Tech Top"},           // Magna Charge
    {{2004, 0x0000}, "Fire Top"},           // Blast Zone
    {{2002, 0x0000}, "Earth Top"},          // Rubble Rouser
    {{2006, 0x0000}, "Life Top"},           // Stink Bomb

    {{1008, 0x0000}, "Magic Bottom"},       // Hoot Loop
    {{1015, 0x0000}, "Water Bottom"},       // Wash Buckler
    {{1001, 0x0000}, "Air Bottom"},         // Free Ranger
    {{1013, 0x0000}, "Undead Bottom"},      // Rattle Shake
    {{1010, 0x0000}, "Tech Bottom"},        // Magna Charge
    {{1004, 0x0000}, "Fire Bottom"},        // Blast Zone
    {{1002, 0x0000}, "Earth Bottom"},       // Rubble Rouser
    {{1006, 0x0000}, "Life Bottom"},        // Stink Bomb

    // Trap Team stuff
    {{210, 0x300E}, "Magic Trap"},
    {{211, 0x3001}, "Water Trap"},
    {{212, 0x3003}, "Air Trap"},
    {{213, 0x3008}, "Undead Trap"},
    {{214, 0x3007}, "Tech Trap"},
    {{215, 0x3005}, "Fire Trap"},
    {{216, 0x3000}, "Earth Trap"},
    {{217, 0x300A}, "Life Trap"},
    {{218, 0x3014}, "Dark Trap"},
    {{219, 0x300F}, "Light Trap"},
    {{220, 0x301E}, "Kaos Trap"},

    {{210, 0x300E}, "Magic Trap Master"},   // Blastermind
    {{211, 0x3001}, "Water Trap Master"},   // Snap Shot
    {{212, 0x3003}, "Air Trap Master"},     // Gusto
    {{213, 0x3008}, "Undead Trap Master"},  // Krypt King
    {{214, 0x3007}, "Tech Trap Master"},    // Jawbreaker
    {{215, 0x3005}, "Fire Trap Master"},    // Wildfire
    {{216, 0x3000}, "Earth Trap Master"},   // Wallop
    {{217, 0x300A}, "Life Trap Master"},    // Tuff Luck
    {{218, 0x3014}, "Dark Trap Master"},    // Knight Mare
    {{219, 0x300F}, "Light Trap Master"},   // Knight Light

    // Superchargers
    {{3402, 0x0000}, "Magic Supercharger"}, // Splat
    {{3422, 0x0000}, "Water Supercharger"}, // Deep Dive Gill Grunt
    {{3406, 0x0000}, "Air Supercharger"},   // Stormblade
    {{3417, 0x0000}, "Undead Supercharger"},// Bone Bash Roller Brawl
    {{3414, 0x0000}, "Tech Supercharger"},  // Double Dare Trigger Happy
    {{3412, 0x0000}, "Fire Supercharger"},  // Spitfire
    {{3416, 0x0000}, "Earth Supercharger"}, // Shark Shooter Terrafin
    {{3415, 0x0000}, "Life Supercharger"},  // Super Shot Stealth Elf
    {{3427, 0x0000}, "Dark Supercharger"},  // Nightfall
    {{3426, 0x0000}, "Light Supercharger"}, // Astroblast
    
    {{3224, 0x0000}, "Land Vehicle"},       // Hot Streak
    {{3238, 0x0000}, "Sea Vehicle"},        // Splatter Splasher
    {{3232, 0x0000}, "Sky Vehicle"},        // Sky Slicer
};
